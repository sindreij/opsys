...
public class Process implements Constants
{
    ...
    public void startCpu(long clock) {
    	timeSpentInReadyQueue += clock - timeOfLastEvent;
    	timeOfLastEvent = clock;
    }

    public void endCpu(long clock) {
    	long elapsed = clock - timeOfLastEvent;
    	timeSpentInCpu += elapsed;
    	cpuTimeNeeded -= elapsed;
    	timeToNextIoOperation -= elapsed;
    }
	...
	public void updateStatistics(Statistics statistics, long clock) {
		...
		statistics.timesPlacedInCpuQueue += nofTimesInReadyQueue;
		statistics.timesPlacedInIoQueue += nofTimesInIoQueue;
		statistics.totalTimeSpentWaitingForCpu += timeSpentInReadyQueue;
		statistics.totalTimeInTheSystem += clock - creationTime;
