...
public class Statistics
{
	...
	public void printReport(long simulationLength) {
		...
		System.out.println();
		System.out.println("Total CPU time spent processing:                              "+busyCpuTime+" ms");
		System.out.println("Fraction of CPU time spent processing:                        "+(float)busyCpuTime*100/simulationLength+"%");
		System.out.println("Total CPU time spent waiting:                                 "+idleCpuTime+" ms");
		System.out.println("Fraction of CPU time spent waiting:                           "+(float)idleCpuTime*100/simulationLength+"%");
		System.out.println();
		...
		if(nofCompletedProcesses > 0) {
			...
			System.out.println("Average # of times a process has been placed in cpu queue:    "+
					(float)timesPlacedInCpuQueue/nofCompletedProcesses);
			System.out.println("Average # of times a process has been placed in I/O queue:    "+
					(float)timesPlacedInIoQueue/nofCompletedProcesses);
			System.out.println();
			...
			System.out.println("Average time spent processing per process:                    "+
					totalTimeSpentProcessing/nofCompletedProcesses+" ms");
